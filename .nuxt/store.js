...
void (function updateModules() {
  ...
  resolveStoreModules(require('@/store/cheyuan.js'), 'cheyuan.js')
  resolveStoreModules(require('@/store/wuliu.js'), 'wuliu.js')
  resolveStoreModules(require('@/store/huoyuan.js'), 'huoyuan.js')
  resolveStoreModules(require('@/store/line.js'), 'line.js')
  resolveStoreModules(require('@/store/lllapi.js'), 'lllapi.js')
