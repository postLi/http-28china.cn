    ...
    <div class="footer clear">
      <div class="center">
        ...
        <div class="footer1">
          ...
          <a href="http://www.28tms.cn">云TMS</a>
        ...
        <div class="footer2 center">
          ...
          <p>备案：<a 
            ...
            target="_blank">粤ICP备16061301号-4</a></p>
          <p>Copyright © 2018-2021 anfachina.com All rights reserved</p>
        </div>
      </div>
    </div>
      ...
      var AFWL_API = {
        ...
        findPassword: function(data) {
          ...
          return $.ajax({
            url:
              this.url +
              '/aflc-common/common/aflcMemberCenter/v1/retrievePassword',
