    ...
    <div
      ...
      <div class="hz_nav" >
        <ul 
          ...
          <li id="wlzx"><a href="/zhuanxian/list" >物流专线</a></li>
          <li id="hy"><a href="/huoyuan">货源信息</a></li>
          <li id="cy"><a href="/cheyuan">车源信息</a></li>
          <li id="gs"><a href="/gongsi">物流公司</a></li>
          <li id="wd"><a href="/wangdian">物流网点</a></li>
          <li id="sx"><a href="/shixiao">时效查询</a></li>
          <li id="wlyq"><a href="/wuliu/list">物流园区</a></li>
          <li id="jgzs">
            <a 
          ...
          <li >
            <a
              target="_blank"
              href="/Insurance">保险商城</a>
          </li>
          <li id="news"><a href="/zixun">物流资讯</a></li>
        </ul>
      </div>
    </div>
  </div>
...
.h_m_search {
  ...
  font-size: 16px;
  cursor: pointer;
  background: url(../../static/images/index/03search.png) no-repeat #3f94ee
    center;
}
