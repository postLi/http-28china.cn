<template>
  ...
  <div class="list-box-right">
    ...
    <div class="line-gg1 line-gg">
      <img 
        src="/line/images/ad1.png" 
        alt="">
    </div>
    <div class="line-gg2 line-gg">
      <img 
        src="/line/images/ad2.png" 
        alt="">
    </div>
    <!-- 专线推荐 -->
    <div id="js007">
          ...
          <ul>
            <li class="advice-list-li">
              <div class="list-title advice-list-title">
                ...
                <span id="tj01">广东-东莞</span><img src="/images/wzlImg/sjt.png"><span id="tj02">河北-石家庄</span>
              </div>
              <div class="list-title advice-list-title" >
