    ...
    <div class="list_box">
      ...
      <div class="list_left">
        ...
        <div
          ...
          <div
            v-if="!lineLists.length || lineLists==[]"
            class="list_none">
...
async function getLineList($axios, currentPage, vo = {}) {
  let parm = vo
...
export default {
  ...
  async asyncData({ $axios, query, app, error }) {
    ...
    let [listA, listB, listC, listD, codeA, codeB, codeC] = await Promise.all([
      ...
      $axios.get(aurl + '/28-web/sysDict/getSysDictByCodeGet/AF026'),
                  ...
                  function fromRouteList(routeOrderBy) {
                    ...
                    if (routeOrderBy == 'creditDesc') {
                      ...
                      $('.list_tiaoj span')
                        .eq(3)
                        .toggleClass('active')
                      $('#tj_price #tj_price1').addClass('active')
                      fetchLineList(currentPage, orderBy)
                    }
                  }
