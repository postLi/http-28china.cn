...
//数量为0开始
	if (num==0){
		$('.banner-box').html(
			'<a href="#" class="banner-item toZtts" style="display:none;"><img  src="space/vip_space1/images/banner_01.jpg"></a>'+
			'<a href="#" class="banner-item toZtts" style="display:none;"><img  src="space/vip_space1/images/banner_02.jpg"></a>'+
			'<a href="#" class="banner-item toZtts" style="display:none;"><img  src="space/vip_space1/images/banner_03.jpg"></a>'+
