    ...
    CityPicker.prototype = {
        ...
        getText: function () {
            ...
            this.$dropdown.find('.city-select')
                .each(function (i,e) {
                    ...
                    if(i === 2 && item){//清空区名item 2018.12.19
                        $(this).data('item', null);
                    }
                    if (item) {
        ...
        feedText: function () {
            ...
            if (text) {
                ...
                this.$textspan.find('>.title').html(text).show();//this.getText() 换成 text 2018.12.19
            } else {
        ...
        output: function (type) {
            ...
            if(code !== 86 && code !== undefined){ //接口 2018.12.19
                if(type === 'city'){
                ...
                $.ajax({
                    ...
                    async:false,
                    url:"/api/aflccommonservice/common/aflcCommonPCA/v1/findAflcCommonPCAByCode?code=" + code,
