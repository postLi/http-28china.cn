...
var code=""
	$.ajax(
		...
		url:"/templets/default/js/province.json",
		dataType: "json",
		async:false,
		data:JSON.stringify(
			{
...
function getcity_zx(code,startCity){
 ...
 return	$.ajax(
		...
		url:"/api/aflc-common/common/aflcCommonPCA/v1/findAflcCommonPCAByCode?code="+code,
		...
		success:function(res){
		    ...
		    var s1='<a href="#" name="'+name+'" ><span>'+name1+'</span></a>';
				 $("#city_box").append(s1);	
			}	
