...
$(function(){
  ...
  var api = {
    ...
    getInfo: function(start, end){
      return this._warpper($.get(this.url + '/api-plugin/cms/cmspricetrend/v1/getPriceLists',{
        fromadd:start,
        toadd:end
      }));
    }
  ...
  function showBigEchart(start, end) {
    ...
    api.getInfo(start, end).done(function(res){
        ...
        series : [
            {
                ...
                data:zhong,
                itemStyle : {
					normal : {color:'#169bd5',areaStyle:{color:'#169bd5'}
            ...
            },
            {
                ...
                data:qing,
                itemStyle : {
					normal : {color:'#333',areaStyle:{color:'#333'}
    ...
    var start = $('.current').find('.linestart').text();
    var end = $('.current').find('.lineend').text();
