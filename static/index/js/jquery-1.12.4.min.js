...
// md5
!function(r){var n=function(r,n){return r<<n|r>>>32-n},t=function(r,n){var t,o,e,u,a;return e=2147483648&r,u=2147483648&n,a=(1073741823&r)+(1073741823&n),(t=1073741824&r)&(o=1073741824&n)?2147483648^a^e^u:t|o?1073741824&a?3221225472^a^e^u:1073741824^a^e^u:a^e^u},o=function(r,o,e,u,a,f,i){var C;return r=t(r,t(t((C=o)&e|~C&u,a),i)),t(n(r,f),o)},e=function(r,o,e,u,a,f,i){var C;return r=t(r,t(t(o&(C=u)|e&~C,a),i)),t(n(r,f),o)},u=function(r,o,e,u,a,f,i){return r=t(r,t(t(o^e^u,a),i)),t(n(r,f),o)},a=function(r,o,e,u,a,f,i){return r=t(r,t(t(e^(o|~u),a),i)),t(n(r,f),o)},f=function(r){var n,t="",o="";for(n=0;n<=3;n++)t+=(o="0"+(r>>>8*n&255).toString(16)).substr(o.length-2,2);return t};jQuery.extend({md5:function(r){var n,i,C,c,g,h,d,v,m,S=Array();for(S=function(r){for(var n,t=r.length,o=t+8,e=16*((o-o%64)/64+1),u=Array(e-1),a=0,f=0;f<t;)a=f%4*8,u[n=(f-f%4)/4]=u[n]|r.charCodeAt(f)<<a,f++;return a=f%4*8,u[n=(f-f%4)/4]=u[n]|128<<a,u[e-2]=t<<3,u[e-1]=t>>>29,u}(r=function(r){r=r.replace(/\x0d\x0a/g,"\n");for(var n="",t=0;t<r.length;t++){var o=r.charCodeAt(t);o<128?n+=String.fromCharCode(o):o>127&&o<2048?(n+=String.fromCharCode(o>>6|192),n+=String.fromCharCode(63&o|128)):(n+=String.fromCharCode(o>>12|224),n+=String.fromCharCode(o>>6&63|128),n+=String.fromCharCode(63&o|128))}return n}(r)),h=1732584193,d=4023233417,v=2562383102,m=271733878,n=0;n<S.length;n+=16)i=h,C=d,c=v,g=m,h=o(h,d,v,m,S[n+0],7,3614090360),m=o(m,h,d,v,S[n+1],12,3905402710),v=o(v,m,h,d,S[n+2],17,606105819),d=o(d,v,m,h,S[n+3],22,3250441966),h=o(h,d,v,m,S[n+4],7,4118548399),m=o(m,h,d,v,S[n+5],12,1200080426),v=o(v,m,h,d,S[n+6],17,2821735955),d=o(d,v,m,h,S[n+7],22,4249261313),h=o(h,d,v,m,S[n+8],7,1770035416),m=o(m,h,d,v,S[n+9],12,2336552879),v=o(v,m,h,d,S[n+10],17,4294925233),d=o(d,v,m,h,S[n+11],22,2304563134),h=o(h,d,v,m,S[n+12],7,1804603682),m=o(m,h,d,v,S[n+13],12,4254626195),v=o(v,m,h,d,S[n+14],17,2792965006),d=o(d,v,m,h,S[n+15],22,1236535329),h=e(h,d,v,m,S[n+1],5,4129170786),m=e(m,h,d,v,S[n+6],9,3225465664),v=e(v,m,h,d,S[n+11],14,643717713),d=e(d,v,m,h,S[n+0],20,3921069994),h=e(h,d,v,m,S[n+5],5,3593408605),m=e(m,h,d,v,S[n+10],9,38016083),v=e(v,m,h,d,S[n+15],14,3634488961),d=e(d,v,m,h,S[n+4],20,3889429448),h=e(h,d,v,m,S[n+9],5,568446438),m=e(m,h,d,v,S[n+14],9,3275163606),v=e(v,m,h,d,S[n+3],14,4107603335),d=e(d,v,m,h,S[n+8],20,1163531501),h=e(h,d,v,m,S[n+13],5,2850285829),m=e(m,h,d,v,S[n+2],9,4243563512),v=e(v,m,h,d,S[n+7],14,1735328473),d=e(d,v,m,h,S[n+12],20,2368359562),h=u(h,d,v,m,S[n+5],4,4294588738),m=u(m,h,d,v,S[n+8],11,2272392833),v=u(v,m,h,d,S[n+11],16,1839030562),d=u(d,v,m,h,S[n+14],23,4259657740),h=u(h,d,v,m,S[n+1],4,2763975236),m=u(m,h,d,v,S[n+4],11,1272893353),v=u(v,m,h,d,S[n+7],16,4139469664),d=u(d,v,m,h,S[n+10],23,3200236656),h=u(h,d,v,m,S[n+13],4,681279174),m=u(m,h,d,v,S[n+0],11,3936430074),v=u(v,m,h,d,S[n+3],16,3572445317),d=u(d,v,m,h,S[n+6],23,76029189),h=u(h,d,v,m,S[n+9],4,3654602809),m=u(m,h,d,v,S[n+12],11,3873151461),v=u(v,m,h,d,S[n+15],16,530742520),d=u(d,v,m,h,S[n+2],23,3299628645),h=a(h,d,v,m,S[n+0],6,4096336452),m=a(m,h,d,v,S[n+7],10,1126891415),v=a(v,m,h,d,S[n+14],15,2878612391),d=a(d,v,m,h,S[n+5],21,4237533241),h=a(h,d,v,m,S[n+12],6,1700485571),m=a(m,h,d,v,S[n+3],10,2399980690),v=a(v,m,h,d,S[n+10],15,4293915773),d=a(d,v,m,h,S[n+1],21,2240044497),h=a(h,d,v,m,S[n+8],6,1873313359),m=a(m,h,d,v,S[n+15],10,4264355552),v=a(v,m,h,d,S[n+6],15,2734768916),d=a(d,v,m,h,S[n+13],21,1309151649),h=a(h,d,v,m,S[n+4],6,4149444226),m=a(m,h,d,v,S[n+11],10,3174756917),v=a(v,m,h,d,S[n+2],15,718787259),d=a(d,v,m,h,S[n+9],21,3951481745),h=t(h,i),d=t(d,C),v=t(v,c),m=t(m,g);return(f(h)+f(d)+f(v)+f(m)).toLowerCase()}})}();
...
seajs.config({
  alias:{
    'layer': '/member/templets/vendor/layer/layer.js',
    'api': '/member/templets/js/AFLC_API.js',
    'wxLogin': 'https://res.wx.qq.com/connect/zh_CN/htmledition/js/wxLogin.js'
  }
});