...
var rangeIds="";
	$.ajax(
		...
		url:"/api2/aflc-portal/portalt/aflcRecommendTransportRange/v1/recommendRanges",
		dataType: "json",
		async:false,
		data:JSON.stringify(
			{
		...
		success:function(res){
		    ...
		    var collateral=datas[i].collateral;
				...
				$("#tj013").html(lightPrice);
				$("#tj014").html(heavyPrice);
...
var totalPage=8;
	$.ajax(
		...
		url:"/api2/aflc-portal/portalt/aflcRecommendTransportRange/v1/listRanges",
		dataType: "json",
		async:false,
		data:JSON.stringify(
			{
