...
$('.login_bt2').click(function(){
	...
	$('.login_bt2').css({"color":"#2577e3","border-bottom":"1px solid #2577e3"});
...
var myurl=window.location.href;
 ...
 //更换图形验证码 S
var src='/api/aflc-common/common/aflcMemberCenter/v1/getImageCodeAndUID?imageWidth=90&imageHeight=25'
$('#Vcode').attr("src",src);
//alert(1);
...
$.ajax(
		...
		async:false,
		url:"/api/aflc-common/common/aflcMemberCenter/v1/getLogisticsCompanyInfoByMobile/?mobile="+account + '&access_token=' + getCookie("access_token"),
...
function Is_login1(){
    ...
    if(login_mobile&&login_type&&access_token){	
     ...
     if(login_type=="aflc-5"){var login_name=wuliu(login_mobile,access_token)}
