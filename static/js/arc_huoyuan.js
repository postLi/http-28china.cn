...
function process01() {
  $.ajax({
    ...
    success: function(res) {
      ...
      if (startProvinceCityArea && startProvinceCityArea.length > 15) {
        startProvinceCityArea = startProvinceCityArea.substring(0, 15) + '..'
      }
      if (endProvinceCityArea && endProvinceCityArea.length > 15) {
        endProvinceCityArea = endProvinceCityArea.substring(0, 15) + '..'
      }
      ...
      if (consignorAddress) {
        consignorAddress = consignorAddress.substring(0, 10)
      }
      if (datas.shipperDesc == null) {
        var shipperDesc = '暂未填写简介信息！'
      } else {
        var shipperDesc = datas.shipperDesc.substring(0, 400)
      }
      ...
      $('#arc_nav_a2').html(
        startCity + startArea + '到' + endCity + endArea + '货源信息'
      )
      $('#arc_nav_a1').attr(
        'href',
        '/plus/list.php?tid=2' +
