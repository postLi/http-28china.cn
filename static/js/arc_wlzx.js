...
function process1() {
  $.ajax({
    ...
    success: function(res) {
      ...
      if (!transportRemark) {
        transportRemark =
          '暂无专线说明。点击为您推荐<a target="_blank" href="/plus/list.php?tid=4&start=' +
          startCity +
          '&end=' +
          endCity +
          '">更多专线</a>'
...
function process04(currentPage) {
  ...
  $.ajax({
    ...
    url:
      '/api/aflc-portal/portal/aflcTransportEvaluation/v1/rangeEvaluationlist',
    dataType: 'json',
    async: false,
    data: JSON.stringify({
...
function process5() {
  $.ajax({
    ...
    url:
      '/api/aflc-portal/portal/aflcTransportEvaluation/v1/rangeEvaluationCount/' +
      aid,
