;(function() {
  ...
  var p = keywords.split(',')[0] || startp
  var c = keywords.split(',')[2] || startc
  ...
  function process01() {
    ...
    $.ajax({
      ...
      url: '/api/28-web/range/home/recommend',
      ...
      success: function(res) {
        ...
        for (var i = 0; i < datas.length; i++) {
          ...
          var publishName = datas[i].companyName
          ...
          var arcurl =
            '/zhuanxian/detail?id=' + rangeId + '&publishId=' + companyId
  ...
  var urls = url.split('/')
  var isp = urls.length === 3
  var purl = isp ? url : '/zhuanxian/' + urls[2] + '.htm'
  var curl = isp
    ? '/zhuanxian/' +
      urls[2].replace('.htm', '') +
      '/' +
  ...
  $('#list_nav_a1').html(p + '零担物流专线')
  $('#list_nav_a2').html(c + '零担物流专线')
  $('#list_nav_a1').attr('href', purl)
  $('#list_nav_a2').attr('href', curl)
})()
