  ...
  $.ajax({
    ...
    success: function(res) {
      ...
      if (id) {
        ...
        if (n == 1) {
          $('.cp_1').css('display', 'block')
        }
        if (n == 2) {
          $('.cp_2').css('display', 'block')
        }
        if (n == 3) {
          $('.cp_3').css('display', 'block')
        }
        if (n == 4) {
          $('.cp_4').css('display', 'block')
        }
        if (n >= 5 || n < 1) {
          $('.cp_5_8').css('display', 'block')
        }
        for (var i = 1; i < 10; i++) {
        ...
        if (n == 1) {
          $('.fw_1').css('display', 'block')
        }
        if (n == 2) {
          $('.fw_2').css('display', 'block')
        }
        if (n == 3) {
          $('.fw_3').css('display', 'block')
        }
        if (n == 4) {
          $('.fw_4').css('display', 'block')
        }
        if (n >= 5 || n < 1) {
          $('.fw_5_8').css('display', 'block')
        }
        for (var i = 1; i < 9; i++) {
          if (otherServiceCode) {
  ...
  $.ajax({
    ...
    success: function(res) {
      ...
      for (var i = 0; i < datas.length; i++) {
        ...
        $('#nr0007').attr(
          'href',
          orglink + '?id=' + id + '&publishId=' + companyId
        )
