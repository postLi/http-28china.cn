!(function(a) {
  var e = function(b, c) {
    ;(this.ele = b),
      ...
      (this.opts = a.extend({}, this.defaults, c)),
  ...
  ;(e.prototype = {
    ...
    checkPage: function() {
      var a = this.opts,
        b = this.total,
        c = this.current
      a.isShow || (this.homePage = this.endPage = ''),
        1 === c && (this.homePage = this.prevPage = ''),
        c === b && (this.endPage = this.nextPage = ''),
        1 === b &&
    ...
    getPagesTpl: function() {
      ...
      return (
        d +
        '<input type="text" class="page_input" style="" placeholder="页码" /><a class="ui-pagination-page-btn" href="javascript:void(0);">跳转</a>'
      )
    },
    setPage: function(a, b) {
      return a === this.current && b === this.total
        ? this.ele
        : ((this.current = a), (this.total = b), this.render(), this.ele)
    },
    getPage: function() {
      return {
    ...
    eventBind: function() {
      ...
      this.ele
        ...
        .on('click', '.ui-pagination-page-item', function() {
          ...
          c.current != b &&
            ((c.current = b), c.render(), d && 'function' == typeof d && d(b))
        })
        .on('click', '.ui-pagination-page-btn', function() {
          var e = parseInt(
            a(this)[0].parentNode.getElementsByTagName('input')[0].value
          )
          e &&
            'NaN' != e &&
            e > 0 &&
            c.current != e &&
            b >= e &&
            ((c.current = e), c.render(), d && 'function' == typeof d && d(e))
        })
    }
  }),
